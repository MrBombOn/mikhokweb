...
type GalleryRow = { id: number; folderId: number; titleHu: string; titleEn: string; date: string };
...
export function GalleryModule() {
  ...
  const [items, setItems] = useState<GalleryRow[]>(() => galleryItems.map((item) => ({ ...item })));
