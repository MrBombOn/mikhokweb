...
useEffect(() => {
  ...
  void (async () => {
    ...
    else setNewsItems(canUseDemoFallback() ? getDemoNews() : []);
  })();
  return () => {
    cancelled = true;
  };
