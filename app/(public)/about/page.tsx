/**
 * @file About Us – statikus marketing layout (szerverkomponens)
 *
 * @description
 * Route: `/about`. A `Card` és `SectionHeader` primitívekkel épített statikus tartalom;
 * később CMS / Prisma mezőkből tölthető.
 */
